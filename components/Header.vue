<template>
  <div class="hero-anime">
    <div class="navigation-wrap bg-light start-header start-style" ref="header">
      <div class="container">
        <div class="row">
          <div class="col-12">
      ...
      <div class="absolute-center">
        ...
        <div class="section mt-5">
          <div class="container">
            <div class="row">
              <div class="col-12">
                <div id="switch" @click="toggleDarkMode">
                  <div id="circle"></div>
                </div>
              </div>
            </div>
...
const toggleDarkMode = () => {
  ...
  document.getElementById('switch').classList.toggle('switched');
};
...
onMounted(() => {
  const handleScroll = () => {
    ...
    if (scroll >= 10) {
      header.value.classList.remove('start-style');
      header.value.classList.add('scroll-on');
    } else {
      header.value.classList.remove('scroll-on');
      header.value.classList.add('start-style');
    }
  };
